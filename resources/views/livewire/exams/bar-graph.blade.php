<div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-6 md:p-6">
    ...
    <div class="py-8 justify-center" id="result">
        <input id="minmax-range" type="range" min="0" max="100" value="{{ $last_exam->result }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
