    ...
    <table class="w-full table-auto">
        <thead>
            <tr class="bg-gray-200 text-left dark:bg-meta-4">
                <th class="p-4 font-medium text-black dark:text-white xl:pl-11">日付</th>
                <th class="p-4 font-medium text-black dark:text-white xl:pl-11">結果</th>
                <th class="p-4 font-medium text-black dark:text-white xl:pl-11"></th>
            </tr>
        </thead>
        <tbody>
